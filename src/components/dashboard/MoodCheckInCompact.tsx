        ...
        <div className="space-y-4">
            <div className="glass-card neon-border-violet p-4 md:p-5">
                <div className="flex items-center justify-between gap-3 mb-3">
                    ...
                    <div
                        className={`flex items-center gap-1 text-xs font-mono ${moodTrend === null
                    ...
                    <div className="grid grid-cols-5 gap-1.5 md:gap-2 flex-1">
                        {MOODS.map((m) => (
                            <button
                                ...
                                title={m.label}
                                className={`flex flex-col items-center justify-center gap-1 py-2 rounded-lg border transition-all ${selected === m.value
