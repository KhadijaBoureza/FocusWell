          ...
          return (
            ...
            >
              <div className={`mx-auto w-12 h-12 rounded-full flex items-center justify-center mb-3 ${
                ...
                <badge.icon size={24} className={earned ? badge.colorClass : "text-muted-foreground/40"} />
              </div>
              <h3 className={`font-mono text-xs font-bold mb-1 ${earned ? "text-foreground" : "text-muted-foreground/50"}`}>
                {badge.title}
              </h3>
              <p className={`text-[10px] leading-tight ${earned ? "text-muted-foreground" : "text-muted-foreground/40"}`}>
                {badge.description}
              </p>
              {earned && (
